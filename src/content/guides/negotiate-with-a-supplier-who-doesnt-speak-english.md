...
1. **Every number is spoken and typed.** Quantities, unit prices, currencies, dates, tolerances. No exceptions.
2. **Confirm commitments by restatement.** "To confirm: twelve thousand units, four euros eighty each, delivered by the fifteenth of March." Then type it.
3. **Never accept a nod.** Ask them to state the commitment back in their own words. In several business cultures, disagreeing directly with a customer is impolite, and you will get agreement that is not agreement.
4. **Ask what would make the date slip.** A supplier who cannot answer that has not planned it.
5. **Written summary within the hour**, in both languages, sent to everyone on the call.
